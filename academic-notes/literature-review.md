...
The purpose of this file is not to provide a complete survey of the blockchain literature. Instead, it documents the references that directly support the concepts, architectural comparisons, and security considerations discussed in the repository.
...
**Used for:**
Understanding the basic structure of blockchain-based record keeping, hash-linked transaction history, decentralized validation, and distributed ledger immutability.

**Why included:**
This reference provides historical and conceptual background for blockchain systems. It supports the discussion of replicated ledgers, transaction ordering, and append-only records in the distributed ledger abstractions document.
...
**Why included:**
This paper provides foundational background for the trust and fault-tolerance assumptions discussed in distributed ledger systems. It is used as conceptual support for later discussion of consensus and validation.
...
* [Consensus and Validation](../docs/consensus-and-validation.md)
* [Security Models](../docs/security-models.md)
...
**Used for:**
Understanding Ethereum accounts, transactions, gas, smart contracts, contract storage, the EVM, and transaction execution.

**Why included:**
The official Ethereum documentation provides practical and technical support for the Ethereum-related descriptions in the architecture and security sections.

### Solidity Documentation

**Used for:**
Understanding Solidity contract structure, functions, contract storage, external calls, modifiers, and ABI-based interaction.

**Why included:**
This reference supports the discussion of Ethereum developer abstractions and smart contract programming patterns.
...
**Used for:**
Understanding Solana’s architectural design, including Proof of History, high-throughput design goals, and the separation between ordering and execution.
...
**Used for:**
Understanding Solana accounts, programs, transactions, account ownership, fees, runtime behavior, and transaction processing.

**Why included:**
The official Solana documentation supports the explanation of Solana’s account-centric architecture and explicit account validation model.

### Anchor Documentation

**Used for:**
Understanding Solana smart contract development patterns, account validation, serialization, constraints, and program structure.
...
**Used for:**
Understanding EOSIO’s account model, permission structure, Delegated Proof of Stake design, and resource model.
...
**Used for:**
Understanding accounts, actions, permissions, multi-index tables, CPU/NET/RAM resources, and smart contract development patterns.

**Why included:**
This documentation supports the practical explanation of EOSIO’s developer model and table-oriented state management.

### Antelope Documentation

**Used for:**
Understanding EOSIO-derived architecture and tooling.
...
**Used for:**
Understanding content-addressed storage, off-chain data references, and decentralized file storage assumptions.

**Why included:**
This reference supports the discussion of on-chain/off-chain storage trade-offs, especially the distinction between storing data on-chain and storing content-addressed references to off-chain data.

### IPFS Documentation

**Used for:**
Understanding practical IPFS concepts such as content identifiers, content addressing, and data retrieval.

**Why included:**
The documentation supports the practical storage discussion related to IPFS-based decentralized storage.
...
**Used for:**
Understanding practical smart contract security risks, including reentrancy, access control, external calls, and transaction-ordering assumptions.
...
**Why included:**
This reference supports the methodology of comparing Ethereum, Solana, and EOSIO through dimensions such as state model, execution model, consensus assumptions, resource model, and developer abstraction.
